      ...
      <CardContent className="p-0">
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          {currentStep === 5 && (
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-bold mb-6">Review Your Registration</h3>
                <p className="text-muted-foreground mb-6">
                  Please review your registration information carefully before submitting. You can go back to previous
